...
class Hpp extends Component
{
    ...
    public function render()
    {
        ...
        $this->order_json = (json_decode($this->order_array,true));
        // dd($this->order_json);
        // dd($this->order_json);
        $symbol = $this->order_json['Symbol'];
        $amount = $this->order_json['Amount'];
        // $currency = $this->order_json['Currency'];
        $this->Value = $symbol . ' ' . $amount;
    ...
    {
        // get the total of the order to pass to the header
        $this->emit('orderRendered', $Value);
        // dd($Value);
    }
