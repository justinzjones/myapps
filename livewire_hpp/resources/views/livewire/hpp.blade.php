  ...
  <div class="items-center justify-center w-full">
    ...
    <div class="sm:p-5">
      ...
      <div class="mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
          ...
          <div class="mt-5 md:mt-10 md:col-span-2">
            <form action="{{url('crypto')}}" method="post">
              <!-- wire:submit.prevent="payment_submit()" -->
              @csrf
              
              <input id="total_currency" name="total_currency" type="hidden" value="{{ $order_json['Currency'] }}">
              <input id="total_amount" name="total_amount" type="hidden" value="{{ $order_json['Amount'] }}">
              <input id="order_json" name="order_id" type="hidden" value="{{ $order_json['refId'] }}">
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 border rounded-md sm:col-span-7">
                      <div class="flex items-center flex-1 h-16 px-4 py-3 bg-white rounded-md cursor-pointer select-none hover:-translate-y-1 hover:shadow-lg">
                        ...
                        <label class="inline-flex items-center">
                          <input type="radio" class="w-6 h-6 text-blue-700 form-radio" name="radio_pay_type" value="storedCard">
                    ...
                    <div class="col-span-6 border rounded-md sm:col-span-7">
                      <div class="flex items-center flex-1 h-16 px-4 py-3 bg-white rounded-md cursor-pointer select-none hover:-translate-y-1 hover:shadow-lg">
                        <div class="flex-1 pl-1 mr-5">
                          <div class="font-medium text-blue-700">Bitcoin</div>
                          <!-- <div class="text-xs text-gray-600">12/21</div> -->
                          <!-- <div class="text-sm text-gray-600">200ml</div> -->
                        </div>
                        <div class="flex justify-center w-16">
                          <img class="w-8 h-6 rounded "  src="{{asset('app/images/BitPay-Accepted-Card.png')}}" alt="Image"/>
                        </div>
                        <label class="inline-flex items-center">
                          <input type="radio" class="w-6 h-6 text-blue-700 form-radio" name="radio_pay_type" value="crypto">
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-span-6 border rounded-md sm:col-span-7">
                      <div class="flex items-center flex-1 h-16 px-4 py-3 bg-white rounded-md cursor-pointer select-none hover:-translate-y-1 hover:shadow-lg" x-data="{usedKeyboard: false}" @keydown.window.tab="usedKeyboard = true" @click="$dispatch('open-addcard', { open: true })" :class="{'focus:outline-none': !usedKeyboard}">
                        ...
                        <label class="inline-flex items-center">
                          <input type="radio" class="w-6 h-6 text-blue-700 form-radio" name="radio_pay_type" value="addCard">
                    ...
                    <div class="col-span-6 border rounded-md sm:col-span-7">
                      <div class="flex items-center flex-1 h-16 px-4 py-3 bg-white rounded-md cursor-pointer select-none hover:-translate-y-1 hover:shadow-lg">
                        ...
                        <label class="inline-flex items-center">
                          <input type="radio" class="w-6 h-6 text-blue-700 form-radio" name="radio_pay_type" value="paypal">
                    ...
                    <div class="col-span-6 border rounded-md sm:col-span-7">
                      <div class="flex items-center flex-1 h-16 px-4 py-3 bg-white rounded-md cursor-pointer select-none hover:-translate-y-1 hover:shadow-lg">
                        ...
                        <label class="inline-flex items-center">
                          <input type="radio" class="w-6 h-6 text-blue-700 form-radio" name="radio_pay_type" value="gpay">
          ...
          <div class="mt-5 md:mt-10 md:col-span-2">
              ...
              <div class="overflow-hidden rounded-md shadow">
                <div class="flex items-center p-4 bg-white sm:p-6">
                  ...
                  <input type="checkbox" checked class="w-6 h-6 border-gray-500 rounded-md form-checkbox">
      ...
      <div class="float-right sm:mt-0">
        ...
        <button type="submit" class="w-full px-4 py-2 my-10 font-bold text-white bg-gray-500 border border-blue-700 rounded hover:bg-gray-700">
