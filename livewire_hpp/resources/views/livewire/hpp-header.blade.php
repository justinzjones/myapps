<header>
    <nav class="flex flex-wrap items-center justify-between px-2 py-2 bg-blue-900">
        ...
        <div class=" flex flex-shrink-0 px-2 text-white">
            ...
            <div class="sm:hidden block pr-2">
                
                    <button x-data="{usedKeyboard: false}" @keydown.window.tab="usedKeyboard = true" @click="$dispatch('open-hamburger', { open: true })" :class="{'focus:outline-none': !usedKeyboard}" class="hover:text-white hover:border-white flex items-center px-3 py-2 border rounded">
        ...
        <button class="sm:hidden block pr-2" 
            x-data="{usedKeyboard: false}" 
            @keydown.window.tab="usedKeyboard = true" 
            @click="$dispatch('open-menu', { open: true })" 
            :class="{'focus:outline-none': !usedKeyboard}">

            <div class="hover:text-white hover:border-white flex px-3 py-2 border rounded">
                <p class=" h-5 pr-2 text-sm font-semibold text-white">{{$value}}</p>
        ...
        <div class="sm:inline-block hidden">
            <div x-data="{ open_modal: false }">
                <button @click="open_modal = true" class="hover:text-white hover:border-white flex items-center px-3 py-2 rounded">
                ...
                <div x-show="open_modal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="ease-in duration-300" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" class="fixed inset-0 z-10 overflow-y-auto">
                    ...
                    <div class="sm:block sm:p-0 flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center">
                        ...
                        <!--
                            ...
                            -->
                        <div @click.away="open_modal = false" class="sm:my-8 sm:align-middle sm:max-w-lg sm:w-full inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                            ...
                            <div class="sm:flex-wrap bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse justify-around px-4 py-3">

                                <button @click="open_modal = false" wire:click="$emit('changeLang','dk')" type="button" class="hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-48 sm:text-sm inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm">
                                ...
                                <button @click="open_modal = false" wire:click="$emit('changeLang','en')" type="button" class="hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-48 sm:text-sm inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm">
                                    <div class="flex justify-center w-full">
    ...
    <section 
      ...
      <div class="transform-gpu fixed top-0 left-0 w-full h-screen max-w-sm overflow-y-scroll transition duration-500 bg-white" :class="{'-translate-x-full': !open}">
      ...
      <button @click="open = false" x-ref="closeButton" :class="{'focus:outline-none': !usedKeyboard}" class="absolute top-0 right-0 mt-3 mr-3">
        ...
        <div class="h-full bg-gray-100">
          ...
          <div class="md:mt-0 md:col-span-2 mt-0 -mx-1">
            ...
            <title class="h-14 flex w-full px-4 py-4 font-semibold text-white bg-gray-500"></title>
