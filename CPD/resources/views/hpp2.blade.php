...
-->
  ...
  <main class="sm:px-6 lg:max-w-7xl lg:px-8 max-w-2xl px-4 py-8 mx-auto">
    ...
    <div x-cloak x-data="{ button: false, radio:true }">
      ...
      <form class="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-16 mt-6" action="/sdk-pay" method="POST">
        ...
        <section aria-labelledby="cart-heading" class="lg:col-span-7">
          ...
          <div x-show="button" class="">
            <fieldset>
              ...
              <div class="gap-y-hpp sm:grid-cols-3 sm:gap-x-4 grid grid-cols-1 mt-0">
                ...
                <label class="ring-2 ring-sky-500 hover:drop-shadow focus:outline-none relative flex p-4 bg-white border border-sky-500 rounded-lg shadow-sm cursor-pointer">
                  ...
                  <svg class="w-5 h-5 text-sky-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <label class="hover:drop-shadow focus:outline-none relative flex p-4 bg-white border rounded-lg shadow-sm cursor-pointer">
                  ...
                  <svg class="hidden w-5 h-5 text-sky-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                  </svg>
            ...
            <fieldset class="sm:mt-0">
              <div class="sm:flex sm:items-center sm:space-y-0 sm:space-x-10 justify-around space-y-0">
                <div class="sm:border-none hover:bg-white sm:hover:bg-white flex items-center py-4 border-b border-gray-100 cursor-pointer">
                  <input id="email" name="notification-method" type="radio" checked class="focus:ring-sky-500 w-4 h-4 text-sky-600 border-gray-300">
                ...
                <div class="sm:border-none flex items-center py-4 border-b border-gray-100">
                  <input id="sms" name="notification-method" type="radio" class="focus:ring-sky-500 w-4 h-4 text-sky-600 border-gray-300">
                ...
                <div class="sm:border-none flex items-center py-4 border-b border-gray-100">
                  <input id="push" name="notification-method" type="radio" class="focus:ring-sky-500 w-4 h-4 text-sky-600 border-gray-300">
          ...
          <div class="mt-1">
            ...
            <div class="gap-y-6 gap-x-4 grid grid-cols-4 mt-5">
              ...
              <div class="sm:col-span-2 col-span-4">
                ...
                <div class="mt-1">
                  <input type="text" name="cvc" id="cvc" autocomplete="csc" class="focus:ring-sky-500 focus:border-sky-500 sm:text-sm block w-full border-gray-300 rounded-md shadow-sm">
                </div>
              </div>
            </div>
          ...
          <!-- This example requires Tailwind CSS v2.0+ -->
          <div class="sm:rounded-lg bg-sky-50 mt-10 mb-10">
                ...
                <div class="sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:flex sm:items-center mt-5">
                  <div>
                    ...
                    <div class="mt-1">
                      ...
                      <button type="button" class="px-14 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 md:text-lg sm:text-xl items-center block py-5 mx-auto mt-0 text-lg font-medium text-white bg-gray-600 border border-transparent rounded-md shadow-sm">
          ...
          <!-- <button type="submit" class="hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-sky-500 w-full px-4 py-3 mt-10 text-base font-medium text-white bg-sky-600 border border-transparent rounded-md shadow-sm">Checkout</button> -->

        </section>


        <!-- Order summary -->
        <section aria-labelledby="summary-heading" class="hidden lg:block sm:p-6 lg:p-8 lg:mt-0 lg:col-span-5 bg-sky-50 px-4 py-6 mt-16 rounded-lg">
        ...
        <!-- <ul role="list" class="text-sm font-medium text-gray-900 divide-y divide-gray-200">
            <li class="flex items-start py-6 space-x-4">
              <img src="https://tailwindui.com/img/ecommerce-images/checkout-page-04-product-01.jpg" alt="Moss sky canvas compact backpack with double top zipper, zipper front pouch, and matching carry handle and backpack straps." class="flex-none object-cover object-center w-20 h-20 rounded-md">
  ...
  <footer aria-labelledby="footer-heading" class="bg-gray-50 border-t border-gray-200">
