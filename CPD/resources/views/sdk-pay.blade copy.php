...
<head>
  ...
  <script src="https://websdk.testing.cpm.dev/sdk.js"></script>
      ...
      <div class="max-w-2xl mx-auto lg:max-w-none">
        ...
        <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
          ...
          <div class="form-wrapper">
            ...
            <div class="cc-form" style="display: none;">
...
<script>
    const config = {
      ...
      // cardsMeta: CardsMeta; // The cards data returned from the init transaction request
    ...
    // CellPoint.subscribe((msg) => {
    //   alert('The fields are not valid!')
