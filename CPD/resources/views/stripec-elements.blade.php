...
<head>
  ...
  <script src="{{ asset('js/checkout.js/?$client_secret') }}" defer></script>
      ...
      <main class="max-w-7xl sm:px-6 lg:px-8 px-4 pt-16 pb-24 mx-auto">
        ...
        <div class="lg:max-w-none max-w-2xl mx-auto">
          ...
          <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16"
            id="payment-form" data-secret="<?= $client_secret ?>">
            <div>
              <p id="client_secret">{{$client_secret}}</p>
              <div>
            ...
            <div class="lg:mt-0 mt-10">
              ...
              <div class="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <!-- <div class="sm:px-6 px-4 py-6 border-t border-gray-200">
                  <button id="card-button" type="submit" class="hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 w-full px-4 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm">Confirm order</button>
                </div> -->
              </div>
            </div>
          </form>
