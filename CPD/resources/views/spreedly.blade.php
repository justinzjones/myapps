...
<head>
  ...
  <script src="{{ asset('js/spreedly.js') }}" defer></script>
...
-->
  ...
  -->
    ...
    <div class="lg:max-w-none max-w-2xl mx-auto">
      ...
      <form id="payment-form" class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16"
        action="http://localhost/checkout"
          ...
          <div class="pt-10 mt-10 border-t border-gray-200">
            ...
            <div class="gap-y-6 gap-x-4 grid grid-cols-4 mt-6">
              <div class="col-span-4">
                ...
                <div class="mt-1">
                  <div id="spreedly-number" name="card-number" autocomplete="cc-number"  style="width:225px; height:37px; border: 1px solid" class="rounded">
                     <!-- spreedly please inject the field here -->
                  </div>
                </div>
              </div>
              ...
              <div class="col-span-4">
                ...
                <div class="mt-1">
                  <input type="text" id="full_name" name="name-on-card" autocomplete="cc-name" class="focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm block w-full border-gray-300 rounded-md shadow-sm">
                </div>
              </div>

              <div class="col-span-3">
                <label for="expiration-date" class="block text-sm font-medium text-gray-700">Expiration date (MM/YYYY)</label>
                <div class="inline-block w-12 mt-1">
                  <input type="text" name="expiration-month" id="exp-month" autocomplete="cc-exp" class="focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <p class="inline-block">/</p>
                <div class="w-14 inline-block mt-1">
                  <input type="text" name="expiration-year" id="exp-year" autocomplete="cc-exp" class="focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm block w-full border-gray-300 rounded-md shadow-sm">
                </div>
              </div>
              ...
              <div>
                ...
                <div class="mt-1">
                  <div name="cvc" id="spreedly-cvv" autocomplete="csc" style="width:60px; height:35px; border: 1px solid" class=" rounded-md" ></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="lg:mt-0 mt-10">
          ...
          <div class="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="sm:px-6 px-4 py-6 border-t border-gray-200">
              <button id="submit-button" type="submit" class="hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 w-full px-4 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm" disabled>Confirm order</button>
            </div>
          </div>
        </div>
      </form>
