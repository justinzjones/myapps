...
export function get(object, path, defaultValue) {
    ...
    if (key.includes(':'))
        key = key.split(':')[0];
    const result = Array.isArray(object) ? object.map((entry) => entry === null || entry === void 0 ? void 0 : entry[key]).filter((entry) => entry) : object === null || object === void 0 ? void 0 : object[key];
    if (follow.length > 0) {
