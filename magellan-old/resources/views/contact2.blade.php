      ...
      <div class="px-4 pb-14 sm:px-0 sm:pb-0">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="absolute inset-x-0 bottom-0 sm:static sm:flex-1 sm:self-stretch">
            <div class="flex px-4 pb-px space-x-8 overflow-x-auto border-t h-14 sm:h-full sm:justify-center sm:overflow-visible sm:border-t-0 sm:pb-0">
              <div class="flex">
                <div class="relative flex">
                  <!-- Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                  <button type="button" class="relative z-10 flex items-center pt-px -mb-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out border-b-2 border-transparent hover:text-gray-800" aria-expanded="false">Women</button>
                </div>
                ...
                <!--
                  ...
                  Leaving: "transition ease-in duration-150"
                    ...
                    To: "opacity-0"
                -->
                <div class="absolute inset-x-0 z-20 text-gray-500 bg-white top-full sm:text-sm">
                  <!-- Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow -->
                  <div class="absolute inset-0 bg-white shadow top-1/2" aria-hidden="true"></div>
                  <!-- Fake border when menu is open -->
                  <div class="absolute inset-0 h-px mx-auto -top-px max-w-7xl sm:top-0 sm:px-6 lg:px-8" aria-hidden="true">
                  ...
                  <div class="relative">
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                      <div class="grid items-start grid-cols-1 pt-10 pb-12 gap-x-6 gap-y-10 md:grid-cols-2 lg:gap-x-8">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:gap-x-8">
                          <div>
                            <p id="clothing-heading" class="font-medium text-gray-900">Clothing</p>
                            <div class="pt-6 mt-4 border-t border-gray-200 sm:grid sm:grid-cols-2 sm:gap-x-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:gap-x-8">
                          <div>
                            ...
                            <ul role="list" aria-labelledby="accessories-heading" class="pt-6 mt-4 space-y-6 border-t border-gray-200 sm:space-y-4">
                              <li class="flex">
                          ...
                          <div>
                            ...
                            <ul role="list" aria-labelledby="categories-heading" class="pt-6 mt-4 space-y-6 border-t border-gray-200 sm:space-y-4">
                              <li class="flex">
              ...
              <div class="flex">
                <div class="relative flex">
                  <!-- Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                  <button type="button" class="relative z-10 flex items-center pt-px -mb-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out border-b-2 border-transparent hover:text-gray-800" aria-expanded="false">Men</button>
                </div>
      ...
      <div class="mx-auto max-w-7xl sm:px-2 lg:px-8">
        <div class="max-w-2xl mx-auto space-y-8 sm:px-4 lg:max-w-4xl lg:px-0">
          <div class="bg-white border-t border-b border-gray-200 shadow-sm sm:rounded-lg sm:border">
            ...
            <div class="flex items-center p-4 border-b border-gray-200 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:p-6">
              <dl class="grid flex-1 grid-cols-2 text-sm gap-x-6 sm:col-span-3 sm:grid-cols-3 lg:col-span-2">
                <div>
              ...
              <div class="relative flex justify-end lg:hidden">
                <div class="flex items-center">
                  <button type="button" class="flex items-center p-2 -m-2 text-gray-400 hover:text-gray-500" id="menu-0-button" aria-expanded="false" aria-haspopup="true">
                ...
                -->
                <div class="absolute right-0 z-10 w-40 mt-2 origin-bottom-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-0-button" tabindex="-1">
                  <div class="py-1" role="none">
                    <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-0-item-0">View</a>
            ...
            <ul role="list" class="divide-y divide-gray-200">
              <li class="p-4 sm:p-6">
                <div class="flex items-center sm:items-start">
                  <div class="flex-shrink-0 w-20 h-20 overflow-hidden bg-gray-200 rounded-lg sm:h-40 sm:w-40">
                    <img src="https://tailwindui.com/img/ecommerce-images/order-history-page-03-product-01.jpg" alt="Moss green canvas compact backpack with double top zipper, zipper front pouch, and matching carry handle and backpack straps." class="object-cover object-center w-full h-full">
                  </div>
                ...
                <div class="mt-6 sm:flex sm:justify-between">
                  ...
                  <div class="flex items-center pt-4 mt-6 space-x-4 text-sm font-medium border-t border-gray-200 divide-x divide-gray-200 sm:ml-4 sm:mt-0 sm:border-none sm:pt-0">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="py-20">
        <div class="grid grid-cols-1 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
          ...
          <!-- Sitemap sections -->
          <div class="grid grid-cols-2 col-span-6 gap-8 mt-10 sm:grid-cols-3 md:col-span-8 md:col-start-3 md:row-start-1 md:mt-0 lg:col-span-6 lg:col-start-2">
          ...
          <div class="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-9 lg:row-start-1">
            ...
            <form class="flex mt-2 sm:max-w-md">
              ...
              <input id="email-address" type="text" autocomplete="email" required class="w-full min-w-0 px-4 py-2 text-base text-gray-900 placeholder-gray-500 bg-white border border-gray-300 rounded-md shadow-sm appearance-none focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
              <div class="flex-shrink-0 ml-4">
                <button type="submit" class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Sign up</button>
              </div>
            </form>
          </div>
        </div>
