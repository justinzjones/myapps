  ...
  <header class="absolute inset-x-0 top-0 z-50 ">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <a href="#" class="text-sm font-semibold leading-6 text-gray-50 text-shadow-sm shadow-gray-500">Product</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-50 text-shadow-sm shadow-gray-400">Features</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-50 text-shadow-sm shadow-gray-400">Marketplace</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-50 text-shadow-sm shadow-gray-400">Company</a>
      </div>
