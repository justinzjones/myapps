<main>
  ...
  <div class="relative isolate pt-14">
    ...
    <div class="absolute inset-0 w-full h-full bg-center bg-cover -z-10 stroke-gray-200" style="background-image: url(http://localhost:8055/assets/{{ $region->data->hero }})"></div>
    <svg class="absolute inset-0 -z-10 h-full w-full stroke-gray-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" aria-hidden="true">
      <defs>
        <pattern id="83fd4e5a-9d52-42fc-97b6-718e5d7ee527" width="200" height="200" x="50%" y="-1" patternUnits="userSpaceOnUse">
          <path d="M100 200V.5M.5 .5H200" fill="none" />
    ...
    <div class="px-6 py-24 mx-auto max-w-7xl sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
      <div class="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
        ...
        <h1 class="max-w-lg mt-10 text-4xl font-bold tracking-tight text-white sm:text-7xl">{!! $region->data->name !!}</h1>
        <p class="mt-6 text-lg leading-8 text-white">{!! $region->data->intro !!}</p>
  ...
  <div class="px-6 mt-20 overflow-hidden bg-white lg:px-8">
    <div class="mx-auto max-w-7xl md:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 mt-12 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
