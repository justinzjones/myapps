  <!-- Footer -->
  <div class="bg-gradient-to-t from-lily-white-200 to-lily-white-50" px-6 mx-auto mt-20 max-w-7xl lg:px-8">
    <footer aria-labelledby="footer-heading" class="relative py-24 border-t border-gray-900/10 sm:py-32">
