<main>
  ...
  <div class="relative isolate pt-14">
    ...
    <div class="absolute inset-0 w-full h-full bg-center bg-cover -z-10 stroke-gray-200" style="background-image: url(http://localhost:8055/assets/{{ $country->data->hero }})"></div>
    <svg class="absolute inset-0 -z-10 h-full w-full stroke-gray-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" aria-hidden="true">
      <defs>
        <pattern id="83fd4e5a-9d52-42fc-97b6-718e5d7ee527" width="200" height="200" x="50%" y="-1" patternUnits="userSpaceOnUse">
          <path d="M100 200V.5M.5 .5H200" fill="none" />
    ...
    <div class="px-6 py-24 mx-auto max-w-7xl sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
      <div class="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="/region/{!! $country->data->fk_region->id !!}" class="ml-4 text-sm font-medium text-gray-200 hover:text-gray-400">{!! $country->data->fk_region->name !!}</a>
                </div>
              </li>
              <li>
                <div class="flex items-center">
                  ...
                  <a href="" class="ml-4 text-sm font-medium text-gray-200 hover:text-gray-400" aria-current="page">{!! $country->data->name !!}</a>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <h1 class="max-w-lg mt-10 text-4xl font-bold tracking-tight text-white sm:text-7xl">{!! $country->data->name !!}</h1>
        <p class="mt-6 text-lg leading-8 text-white">{!! $country->data->intro !!}</p>
    ...
    <div class="relative">
      ...
      <div class="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <div class="grid max-w-2xl grid-cols-1 gap-8 mx-auto mt-6 auto-rows-fr sm:mt-6 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          ...
          @foreach ($country->data->fk_place as $place)
            <article class="relative flex flex-col justify-end px-8 pb-8 overflow-hidden bg-gray-900 isolate rounded-2xl pt-80 sm:pt-48 lg:pt-80">
              <img src="http://localhost:8055/assets/{{ $place->hero }}" alt="" class="absolute inset-0 object-cover w-full h-full -z-10">
              ...
              <div class="flex flex-wrap items-center overflow-hidden text-sm leading-6 text-gray-300 gap-y-1">
                ...
                <div class="flex items-center -ml-4 gap-x-4">
                  ...
                  <div class="flex gap-x-2.5">
                    <img src="http://localhost:8055/assets/{{ $place->hero }}" alt="" class="flex-none w-6 h-6 rounded-full bg-white/10">
                    Michael Foster
                  </div>
                </div>
              </div>
          ...
          @endforeach
          {{-- <article class="relative flex flex-col justify-end px-8 pb-8 overflow-hidden bg-gray-900 isolate rounded-2xl pt-80 sm:pt-48 lg:pt-80">
            <img src="http://localhost:8055/assets/{{ $country->data->fk_place[0]->hero }}" alt="" class="absolute inset-0 object-cover w-full h-full -z-10">
            <div class="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
            <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
            ...
            <div class="flex flex-wrap items-center overflow-hidden text-sm leading-6 text-gray-300 gap-y-1">
              ...
              <div class="flex items-center -ml-4 gap-x-4">
                ...
                <div class="flex gap-x-2.5">
                  <img src="http://localhost:8055/assets/{{ $country->data->fk_place[0]->hero }}" alt="" class="flex-none w-6 h-6 rounded-full bg-white/10">
                  Michael Foster
                </div>
              </div>
            </div>
  ...
  <!-- Experiences section -->
  <div class="px-6 mx-auto mt-20 overflow-hidden bg-white max-w-7xl lg:px-8">
    <div class="mx-auto max-w-7xl md:px-6 lg:px-0">
      <div class="max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Holiday ideas</h2>
        <p class="mt-2 text-lg leading-8 text-gray-600">Jordan offers incredible experiences that will help us to create a bespoke and memorable journey for you. Below we have curated an itinerary but it can be customised to fit your agenda.</p>
      </div>
      <div class="grid grid-cols-1 mt-8 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
        <div class="lg:px-0 lg:pr-4 lg:pt-0">
...
-->
    ...
    <ul role="list" class="space-y-6">
      @foreach ($country->data->itineraries as $itinerary)
        <li class="relative flex gap-x-4">
          ...
          <p class="flex-auto py-0.5 text-base leading-5 text-gray-500"><span class="font-medium text-gray-900">{!! $itinerary->name !!}</span></p>
          <time datetime="2023-01-23T11:24" class="flex-none py-0.5 text-xs leading-5 text-gray-500">{!! $itinerary->duration !!} @if($itinerary->duration > 1) days @else day  @endif</time>
        </li>
        <li class="relative flex gap-x-4">
          <div class="absolute top-0 left-0 flex justify-center w-6 -bottom-6">
            <div class="w-px bg-gray-200"></div>
          </div>
          <div class="relative flex-none w-6 h-6 mt-3"></div>
          ...
          <div class="flex-auto">
            ...
            {{-- <div class="relative flex items-center px-6 py-5 space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
              <div class="flex-shrink-0">
                <img class="w-12 h-12 rounded-md" src="http://localhost:8055/assets/{{ $itinerary->image }}" alt="">
              </div>
            ...
            <div class="relative flex items-center space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
              <div class="flex-shrink-0">
                <img class="w-20 h-20 rounded-l-md" src="http://localhost:8055/assets/{{ $itinerary->image }}" alt="">
              </div>
              <div class="flex-1 min-w-0 px-2">
                <a href="#" class="focus:outline-none">
                  <span class="absolute inset-0" aria-hidden="true"></span>
                  {{-- <p class="text-sm font-medium text-gray-900">Leslie Alexander</p> --}}
                  <p class="py-5 text-sm text-gray-500">{!! $itinerary->description !!}</p>
                </a>
              </div>
            </div>
...
{{-- 
      ...
      @endforeach
            ...
            {{-- <div class="relative flex items-center px-6 py-5 space-x-3 bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
              <div class="flex items-center justify-center w-10 h-10 mb-0 bg-indigo-500 rounded-lg">
          ...
          {{-- <div class="max-w-2xl mx-auto lg:mx-0 lg:max-w-lg">
            <h2 class="text-base font-semibold leading-7 text-indigo-600">Featured</h2>
            <p class="mt-2 text-2xl font-bold tracking-tight text-gray-600 sm:text-3xl">A better workflow</p>
            ...
            <dl class="max-w-xl mt-5 space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
              <div class="relative pl-9">
                ...
                <dd class="inline">Spend a couple of days being pampered in a spa beside the Dead Sea, benefitting from the mineral-rich mud.</dd>
              </div>
              <div class="relative pl-9">
                <dt class="inline font-semibold text-gray-900">
                  <svg class="absolute w-5 h-5 text-indigo-600 left-1 top-1" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div class="py-12 sm:px-6 lg:px-6">
          <div id="map" class="pt-4 rounded-lg"></div>
        </div>
      </div>

      {{-- <div class="grid grid-cols-1 mt-4 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
        ...
        <div class="sm:px-6 lg:px-0">
          <div class="relative px-6 pt-8 overflow-hidden bg-indigo-500 isolate sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pl-16 sm:pr-0 sm:pt-16 lg:mx-0 lg:max-w-none">
  ...
  <div class="relative isolate ">
    ...
    <div class="relative">
      <div class="absolute inset-x-0 overflow-hidden -translate-y-1/2 top-1/2 -z-10 transform-gpu opacity-30 blur-3xl" aria-hidden="true">
        <div class="ml-[max(50%,38rem)] aspect-[1313/771] w-[82.0625rem] bg-gradient-to-tr from-[#af80ff] to-[#fc8989]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
      </div>
      <div class="absolute inset-x-0 top-0 flex overflow-hidden opacity-25 -z-10 transform-gpu blur-3xl xl:justify-end" aria-hidden="true">
        <div class="ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] xl:ml-0 xl:mr-[calc(50%-12rem)]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
      </div>
