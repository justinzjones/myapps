        ...
        <div class="max-w-3xl mx-auto text-base leading-7 text-gray-700">
            ...
            <div class="max-w-2xl mt-10">
                ...
                <!-- <ul role="list" class="max-w-xl mt-8 space-y-8 text-gray-600">
                    ...
                    <svg class="flex-none w-5 h-5 mt-1 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <figure class="mt-10 border-l border-indigo-600 pl-9">
                    ...
                    <img class="flex-none w-6 h-6 rounded-full bg-gray-50" src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
            ...
            <!-- <figure class="mt-16">
                <img class="object-cover aspect-video rounded-xl bg-gray-50" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=facearea&w=1310&h=873&q=80&facepad=3" alt="">
