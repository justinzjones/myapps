                ...
                <ul role="list" class="mt-6 bg-white divide-y divide-gray-200">
                    ...
                    <div x-show="cardDisplay">
                        <div :class="cardSelected ? 'bg-gray-50' : 'bg-white'">
                            <div class="container px-0 mx-auto sm:px-6 lg:px-8">
                                <!-- Content goes here -->
                                                            ...
                                                            <div class="flex">
                                                                <div class="flex-shrink-0">
                                                                    ...
                                                                    <div class="w-16 ">
                                                                        <span
                                                                            class="inline-flex text-teal-700 rounded-lg bg-teal-50 ring-4 ring-white">
                                                                            {{-- <img src="https://steel.taigatravel.net/images/GPay.png" alt="Google Pay"> --}}
                                                                            <img class="flex-none w-16 rounded-full bg-gray-50"
                                        ...
                                        <fieldset class="sm:mt-0">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <label for="email"
                                                        class="block ml-4 text-base font-bold text-gray-700"> Card
                                                        payment </label>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="w-24 ml-4">
                                                        <img class="flex-none w-16 rounded-full bg-gray-50"
                                                            src="{{ url('/images/GPay_copy.png') }}" alt="Google Pay">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center py-4 sm:border-none">
                                                    ...
                                                    <!-- <label for="push" class="block ml-3 text-sm font-medium text-gray-700"> Google Pay </label> -->
                                                    <div class="ml-4 w-14">
                                                        <svg enable-background="new 0 0 165.52107 105.9651"
                                                            version="1.1" viewBox="0 0 165.52 105.97"
                                    ...
                                    <form wire:submit.prevent="save">
                                        ...
                                        <div class="pt-8 border-gray-100 mt:10 sm:border-t">
                                            ...
                                            <div class="flex justify-between">
                                                <div class="">
                                                    <h3 class="text-lg font-semibold leading-6 text-gray-900">Card
                                                        details</h3>
                                                    <p class="max-w-2xl mt-1 text-sm font-medium text-gray-500">Please
                                                        provide your card information.</p>
                                                </div>
                                            ...
                                            <div class="grid grid-cols-4 mt-5 gap-y-6 gap-x-4">
                                                <div {{-- @if ($errors->has('number')) :class=" ? 'border-red-700'  : ''" @endif --}} class="col-span-4 md:col-span-2">
                                                    <label for="form.cardNumber"
                                                        class="block text-sm font-medium">Card number</label>
                                                    <div class="mt-1">
                                                        <input x-text=cardNumberField @blur="cardNumberFieldSelected()"
                                                            type="text" wire:model.blur="form.cardNumber"
                                                            id="form.cardNumber" name="form.cardNumber"
                                                            x-model="message"
                                                            class="block w-full rounded-md shadow-sm border-gray-30 focus:ring-governor-bay-500 focus:border-governor-bay-500 sm:text-sm @error('form.cardNumber') border-red-600 @else border-gray-300 @enderror">
                                                        {{-- 
                                                        <p wire:model="form.cardNumberField" x-text="cardNumberField">
                                                        </p> --}}
                                                        {{-- <div x-show="open">
                                                            <span class="text-xs font-semibold text-red-600 ">
                                                                {{ $formRules['card_number']['message'][0] }}
                                                            </span>
                                                        </div> --}}

                                                        <div>
                                                            @error('form.cardNumber')
                                                                <span
                                                                    class="text-xs font-semibold text-red-600 ">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="col-span-4 md:col-span-2">
                                                    <label for="cardName" class="block text-sm font-medium">Name on
                                                        card</label>
                                                    <div class="mt-1">
                                                        <input type="text" wire:model.blur="form.cardName"
                                                            id="form.cardName" name="form.cardName"
                                                            class="block w-full rounded-md shadow-sm border-gray-30 focus:ring-governor-bay-500 focus:border-governor-bay-500 sm:text-sm @error('form.cardName') border-red-600 @else border-gray-300 @enderror">
                                                        <div>
                                                            @error('form.cardName')
                                                                <span
                                                                    class="text-xs font-semibold text-red-600 ">{{ $message }}</span>
                                                ...
                                                <div class="col-span-2">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" name="expiration-date"
                                                            placeholder="MM/YY" id="expiration-date"
                                                            autocomplete="cc-exp"
                                            ...
                                            <div class="mt-8">
                                                <h3 class="text-lg font-semibold leading-6 text-gray-900">Billing
                                                    details</h3>
                                                <p class="max-w-2xl mt-1 text-sm font-medium text-gray-500">Please
                                                    provide your card billing information.</p>
                                            </div>
                                                ...
                                                <div class="mt-0 sm:flex sm:items-start sm:justify-between">
                                                    <div class="w-full max-w-xl text-xs text-gray-700 md:w-3/6">
                                                        ...
                                                        <p>You are also agreeing that the personal data which has
                                                            been provided in connection with this booking can be passed
                                                            to authorities for security purposes.</p>
                                                    </div>
                                                    <div
                                                            ...
                                                            <div class="mt-1">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    Agree and pay now<p
                                                                        ...
                                                                        $2320.00
                                                                        <span
                                                                            class="text-base text-gray-300 ">(USD)</span>
                                                                    </p>
                                                                </button>
                                                            </div>
                                                        </div>
