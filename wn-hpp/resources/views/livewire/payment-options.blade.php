                                ...
                                <div class="flex justify-between px-1">
                                    ...
                                    <div class="flex">
                                        <button type="button"
                                            ...
                                            aria-describedby="availability-description" :aria-checked="split.toString()"
                                            @click="split = !split">
                                        ...
                                        <div id="split-toggle class="inline-flex text-sm" font-medium text-gray-900">
                                            Split</div>
                                    ...
                                    <section aria-labelledby="payment-heading" class="mt-0">
                                        ...
                                        <fieldset class="mb-5 ">
                                            ...
                                            <div :class="split ? '' : 'hidden'"
                                                ...
                                                <!-- Active: "border-governor-bay-600 ring-2 ring-governor-bay-600", Not Active: "border-gray-300" -->
                                                <label
                                                    class="relative flex col-span-3 p-2 rounded-lg focus:outline-none">
                                                    <input type="radio" name="project-type" value="Newsletter"
                                                    ...
                                                    <span class="flex flex-1">
                                                        <span class="flex flex-col w-full">
                                                            ...
                                                            <div class="grid grid-cols-4 mt-0 gap-x-4 gap-y-6 sm:grid-cols-4"
                                                                ...
                                                                <div
                                                                    class="flex justify-between col-span-4 sm:col-span-4">
                                ...
                                <div class="relative pt-5 -space-y-px bg-white rounded-md ">
                                    ...
                                    <label
                                        ...
                                        <span class="flex items-center text-sm">
                                            ...
                                            <!-- Checked: "text-bay-of-many-900", Not Checked: "text-gray-900" -->
                                            <span id="pricing-plans-0-label" class="ml-5 text-xs font-medium">I have
                                                read
                                                and
