<div>
    ...
    <footer class="mt-10 bg-gray-200 border-t-gray-900" aria-labelledby="footer-heading">
        <h2 id="footer-heading" class="sr-only">Footer</h2>
        <div class="max-w-6xl px-6 pt-10 pb-8 mx-auto lg:px-8 ">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8">

                    <img src="{{ url('/images/swa_logo_heart.png') }}" alt="" class="w-auto h-24 opacity-50">

                    <p class="text-sm leading-6 text-gray-600">Change fees don't fly with us! No change fees for anyone,
                        really.</p>
                ...
                <div class="grid grid-cols-2 gap-8 mt-16 xl:col-span-2 xl:mt-0">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            <h3 class="text-sm font-semibold leading-6 text-gray-900">Southwest</h3>
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="#"
            ...
            <div class="pt-8 mt-16 border-t border-gray-900/10 sm:mt-20 lg:mt-24">
                <p class="text-xs leading-5 text-gray-500">&copy; {{ date("Y") }} Southwest Airlines Co. All Rights Reserved. Use
                    of the Southwest websites and our Company Information constitutes acceptance of our Terms and
                    Conditions. Privacy Policy Trademarks Do Not Sell/Share My Personal Information.</p>
            </div>
        </div>
    </footer>
